...
const TrendingSection = () => {
  ...
  const displayItems = shouldShowVideoCard 
    ? [
        {
          video: '/6090546-hd_1920_1080_30fps.mp4',
          isVideo: true
        },
        ...trendingItems
      ]
